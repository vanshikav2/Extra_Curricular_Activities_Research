...
#Observing the different levels of each demographic
levels(data$genderIdentity)
levels(data$studentStatus)
levels(data$major)
levels(data$activityType)
...
both groups is normal. The p-value is 0.0001064 which is less that the significance 
level value of 0.05 indicating that the Genders are not normal.
